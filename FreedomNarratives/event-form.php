         ...
         <div class="card-body">
           ...
           <div class="form-group">
            ...
            <a href="<?php echo $instructions;?>.php" onclick="window.open('<?php echo $instructions;?>',
                               ...
                               'width=500,height=500');
                         return false;" target="_blank"><i class="fas fa-info-circle"></i></a>
            <?php if($event_data[$columns['ColumnName']]=="0"){$text="placeholder=\"Type here\"";}else{$text=$event_data[$columns['ColumnName']];}?>
                 ...
                 <?php while($selected_word = $query_CL->fetch(PDO::FETCH_ASSOC)){
                   ...
                   if($event_data[$columns['ColumnName']]==$selected_word['ID']){
                     ...
                     // echo "<option value=\"".$selected_word['ID']."\">".$selected_word['Name']."</option>";
                      echo "<option value=\"\" selected disabled hidden>".htmlspecialchars_decode($selected_Name['Name'])."</option>";

                   }
                   else {
                      echo "<option value=\"".$selected_word['ID']."\">".htmlspecialchars_decode($selected_word['Name'])."</option>";
                   }
                 } ?>
