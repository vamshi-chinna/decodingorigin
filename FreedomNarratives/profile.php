          ...
          <div class="row">
                  ...
                  <div class="card-body">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                          ...
                          <input type="password" class="form-control" id="exampleInputPassword1" placeholder="New Password" disabled >
                        </div><br>
                        <button type="submit" class="btn btn-primary" disabled>Update</button>
                        <small id="emailHelp" class="form-text text-muted">This page will be functional shortly.</small>
            ...
            <div class="col-xl-4 col-md-6 mb-12">
              <div class="card" style="width: 18rem;">
                    ...
                    <img class="card-img-top" src="img/user/<?php echo $results['img'];?>" alt="User Image">
                  <?php } else {?>
