...
$password=$_POST['new_password'];
	...
	//Updting first_time table 	
	        $sql = "INSERT INTO first_time (email,TimeDate) VALUES (:email,:TimeDate)";
		$stmt = $conn->prepare($sql);
		$stmt->bindParam(':email', $results['email']);
		...
		$message = 'Error in updating logs';
		}
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Password Expired</h4> </div>
...
<p>Hi <?php echo $results['fname'];?>! Our records indicated that your current password is expired. Please update your password below. Only Administrators of this portal can access or edit your password/profile. The password you choose will not be encrypted.</p><br><br>
<?php if(!empty($message)): ?>
		<p><font color=red><?= $message ?></p></font>
	<?php endif; ?> 
                            <form class="form-horizontal form-material" action="first_time.php" method="post">
                                ...
                                <div class="form-group">
                                   ...
                                   <?php } else{ ?>
                                    <h4><i class="fa fa-spin fa-spinner" aria-hidden="true"></i></h4> We are creating your profile. Please wait. 
                                    <?php } ?> 
                                    </div>
                                </div>
